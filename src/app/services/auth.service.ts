...
export class AuthService{
    ...
    login(userForLoginDto:UserForLoginDto):Observable<DataResponse<TokenResultDto>>{
        return this.httpClient.post<DataResponse<TokenResultDto>>(environment.getApiUrl("auth/login"),userForLoginDto)
    }
